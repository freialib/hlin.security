...
// ---- Inspection System -----------------------------------------------------
	...
	/**
	 * @return string role/alias by which the ban/pass was declared
	 */
	...
	/**
	 * @return string how the rule matched
	 */
	function last_matched_type() {
		switch ($this->last_matched_type) {
			...
			default: throw new Panic('Logical error. Unknown last_matched_type in Access.');
		}
	}

	/**
	 * @return string last object to declare ban/pass
	 */
